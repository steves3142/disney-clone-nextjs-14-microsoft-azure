...
import useSWR from "swr"; //React Hooks for Data Fetching, the name "SWR" is derived form stale-while-revaldate, a httpe cache invalidation strategy popularized by HTTP RFC 5861. SWR is a strategy to first return the data from cache (stale), then send the fetch request
//(revalidate) and finaly come with the up-to-date data. 
